...
static inline uint32_t hash_words_inline(const uint32_t *p, size_t n_words, uint32_t basis)
{
    return hash_finish(hash_add_words(basis, p, n_words), n_words * 4);
}

static inline uint32_t hash_words64_inline(const uint64_t *p, size_t n_words, uint32_t basis)
{
...
static inline uint32_t hash_words(const uint32_t p[], size_t n_words, uint32_t basis)
{
    return hash_words__(p, n_words, basis);
}

static inline uint32_t hash_words64(const uint64_t p[], size_t n_words, uint32_t basis)
{
    return hash_words64__(p, n_words, basis);
}
#endif

static inline uint32_t hash_bytes32(const uint32_t p[], size_t n_bytes, uint32_t basis)
{
    return hash_words(p, n_bytes / 4, basis);
}

static inline uint32_t hash_bytes64(const uint64_t p[], size_t n_bytes, uint32_t basis)
{
...
static inline uint32_t hash_add_words(uint32_t hash, const uint32_t *p, size_t n_words)
{
...
static inline uint32_t hash_add_words64(uint32_t hash, const uint64_t *p, size_t n_words)
{
    for (size_t i = 0; i < n_words; i++) {
...
static inline uint32_t hash_add_bytes32(uint32_t hash, const uint32_t *p, size_t n_bytes)
{
    return hash_add_words(hash, p, n_bytes / 4);
}

static inline uint32_t hash_add_bytes64(uint32_t hash, const uint64_t *p, size_t n_bytes)
{
